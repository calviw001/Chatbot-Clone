...
const Home = () => {
  ...
  const handleNewChatAndFirstMessage = async (e) => {
    ...
    try {
      ...
      // Create a new chat
      const userChat = await axios.post(
        `http://localhost:8000/chats/add`,
        {},
      ...
      await axios.post(
        `http://localhost:8000/chats/messages/add_user_question/${userChatId}`,
        userInput,
        { withCredentials: true },
      );
      ...
      await axios.post(
        `http://localhost:8000/chats/messages/add_AI_response/${userChatId}`,
        {},
        { withCredentials: true },
      );
  ...
  return (
    <div className="flex bg-gray-100 min-h-screen">
      ...
      <main
        className={`flex-1 ml-14 transition-all duration-200 flex flex-col min-h-screen ${isOpen ? "lg:ml-64" : "lg:ml-14"}`}
      >
        {/*Header bar*/}
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="bg-white flex flex-col p-4 rounded-xl max-w-3xl w-full mx-auto">
            ...
            <button
              ...
              onClick={handleNewChatAndFirstMessage}
              disabled={isAddButtonDisabled}
            >
              <GoPlus size={24} />
            </button>
